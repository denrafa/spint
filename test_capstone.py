...
def get_data():
    import capstone
    return capstone.get_github_jobs_data()
...
def test_table_exists():
    ...
    connection, cursor = capstone.open_db('testonly.sqlite')
    capstone.create_table(cursor, capstone.make_column_description_from_json_dict(fake_row), fake_table)
...
def test_save_data():  # modern sprint2 version of save data
    ...
    capstone.save_to_db(cursor, fake_table)
